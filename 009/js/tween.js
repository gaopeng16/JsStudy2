...
function animate(ele, obj, nDuration, effectType) {
    ...
    //effectType 1,2,3,4
    if (!effectType) {
        var fn = moveEffect.Linear;//直线，匀速的 1
        ...
        switch (effectType) {
            case 1:
                ...
                break;
            case 2:
                var fn = moveEffect.Quart.easeInOut;//直线，匀速的 1
                break;
            case 3:
                var fn = moveEffect.Elastic.easeOut;//直线，匀速的 1
                break;
            case 4:
                var fn = moveEffect.Bounce.easeOut;//直线，匀速的 1
                break;
            default:
        ...
        if (effectType[0] == 'Linear') {
            var fn = moveEffect.Linear;
        } else {
            var fn = moveEffect[effectType[0]][effectType[1]];
        }
    ...
    function _move() {
        ...
        if (t < d && oChange.length) {//运动的条件
            ...
            //    fnCallback.call(ele);
            //}
            gpEvent.fire.call(ele, "selfMoveEnd");
        }
    }
}